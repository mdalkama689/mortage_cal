...
const MobileShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    "I found this useful mortage affordability calculator tool, check it out: https://seosaurus.in/tools/mortgage-affordability-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/mortgage-affordability-calculator/";
